...
class CTTCosineModel(nn.Module):
    #This model is assumed to be layered
    def __init__(self, input_dimension, hidden_dimensions):
        super(CTTCosineModel, self).__init__()
...
class CTTCosineModelTrainer:
    def __init__(self, input_dimension, hidden_dimensions):
        super(CTTCosineModelTrainer, self).__init__()
        self.input_dimension = input_dimension
        self.hidden_dimensions = hidden_dimensions

    def train(self, left_embedding_matrix, right_embedding_matrix, labels, 
            num_epochs=NUM_EPOCHS, batch_size=BATCH_SIZE):
        self.model = CTTCosineModel(self.input_dimension, self.hidden_dimensions)
        self.device = get_device()
        self.model.to(self.device)
